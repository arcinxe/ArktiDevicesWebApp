...
export class MiniJackChart extends Component {
  static displayName = MiniJackChart.name;
  ...
  fetchData() {
    ...
    let query = 'api/PhonesData/PhonesWithJack?selectedBrandsIds=' + brandsIds;
    console.log(query);
    fetch(query)
  ...
  render() {
    ...
    let contents = this.state.loading
      ...
      : <MyResponsiveBarTest data={this.state.phones} keys={keys} indexBy={indexBy} onClick={this.handleBarClick} colors={colors} itemsSpacing={20}></MyResponsiveBarTest>
